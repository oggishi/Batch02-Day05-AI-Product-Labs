...
|---|---|---|---|
| Case 4: Hỏi Moni tổng chi tiêu tháng → trả về một con số/biểu đồ nhưng **không nói rõ đây chỉ là chi tiêu qua MoMo** (chưa gồm tiền mặt/ngân hàng khác) | [chi_tieu_momo.jpg](../Day06-2A202600778-TranBaDat/01-invidual-workshop/chi_tieu_momo.jpg) | Failure (sai âm thầm) | AI trình bày dữ liệu một phần như thể đầy đủ → cần lộ **phạm vi/độ phủ dữ liệu** |
...
| Giao dịch chuyển tiền/chi hộ bị AI tự gán nhóm (vd "mua sắm") mà **không hiện độ tin cậy**, sửa rồi không rõ có học | case5 | Cần **badge độ tin cậy** + correction **lưu thành rule** |
| Case 5: Moni gợi ý chuyển "tiền nhàn rỗi" sang đầu tư chứng chỉ quỹ **mà không hỏi khoản đó có cần dùng gấp / user có đang nợ không** | case4 | Lời khuyên tài chính cần **suitability-check + disclosure rủi ro** |
