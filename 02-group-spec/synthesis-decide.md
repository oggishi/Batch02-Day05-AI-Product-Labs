...
**Build slice được chọn:** *Flow gửi báo cáo chi tiêu qua email từ chatbot, hiển thị trạng thái gửi thật + recovery options.*

| Câu hỏi | Đạt khi | Trạng thái |
|---|---|---|
| User cụ thể chưa? | User trẻ muốn gửi/báo cáo chi tiêu tháng qua email. | ✅ |
| Task đủ hẹp chưa? | Gửi email báo cáo 1 lần, thông báo trạng thái gửi và cho recovery. | ✅ |
| AI decision rõ chưa? | Chatbot xác nhận email, quyết định khi nào gửi, báo trạng thái gửi. | ✅ |
| Failure path rõ chưa? | Email gửi thất bại / email chưa xác thực → cần recovery options. | ✅ |
| Có evidence không? | Case email gửi báo cáo, case SMS/CSKH over-claim + analog Gmail status. | ✅ |
...
- Thể hiện trực tiếp insight chung: AI over-claim cần status + recovery.
- Mọi thành viên đóng góp: evidence case bot (Bảo Trân), status logic/SPEC (Đạt), integration/demo (Thành Đạt).
